...
class ControllerExtensionModuleStaticContentSeeder extends Controller {
    ...
    private function seedHome($m) {
        ...
        $this->setT($m, $p, 'agency', 'text', [
            ...
            3 => '<p>• Informationsdienste: Verkauf, Vermietung, tägliche Vermietung, Tausch, Kauf von Wohnimmobilien</p><p>• Primär- und Sekundärmarkt; Gewerbeimmobilien</p><p>• Hypermärkte, Einkaufszentren, Geschäfte, Restaurants, Büros usw.</p><p>• Eigentumskomplexe, fertige Geschäfte, Lagerhäuser; Grundstücke</p><p>Kleine und große Investitionsprojekte. Expertenbewertung. Unterstützung bei Verträgen. Provision wird von Eigentümern im Rahmen exklusiver Vereinbarungen gezahlt. Große Immobiliendatenbank seit 2006.</p>',
            4 => '<p>• информационные услуги: продажа, аренда, посуточная аренда, обмен, покупка жилой недвижимости</p><p>• первичный и вторичный рынки; коммерческая недвижимость</p><p>• гипермаркеты, торговые центры, магазины, рестораны, кафе, офисы и т.д.</p><p>• целостные имущественные комплексы, готовый бизнес, склады; земельные участки</p><p>Малые и крупные инвестиционные проекты. Экспертная оценка. Сопровождение при составлении договоров. Комиссию оплачивают собственники по эксклюзивным договорам. Большая база недвижимости с 2006 года.</p>',
        ]);
        ...
        $this->setJson($m, $p, 'partners', 'items', 0, [
            ['image' => 'catalog/svg/partners/partner-1.svg', 'name' => 'Partner 1', 'href' => '#'],
            ['image' => 'catalog/svg/partners/partner-2.svg', 'name' => 'Partner 2', 'href' => '#'],
            ['image' => 'catalog/svg/partners/partner-3.svg', 'name' => 'Partner 3', 'href' => '#'],
            ['image' => 'catalog/svg/partners/partner-4.svg', 'name' => 'Partner 4', 'href' => '#'],
        ]);
