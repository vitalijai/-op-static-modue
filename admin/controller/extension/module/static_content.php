    ...
    private function getSectionRegistry() {
        return [
            ...
            'add' => [
                ...
                'contact_info' => [
                    'label'      => 'Add Property — Contact Info Labels',
                    'sort_order' => 5,
                    'fields'     => [
                        'section_title'     => ['type' => 'text'],
                        'section_highlight' => ['type' => 'text'],
                        'name_label'        => ['type' => 'text'],
                        'name_placeholder'  => ['type' => 'text'],
                        'phone_label'       => ['type' => 'text'],
                        'phone_placeholder' => ['type' => 'text'],
                        'phone2_label'      => ['type' => 'text'],
                        'email_label'       => ['type' => 'text'],
                        'email_placeholder' => ['type' => 'text'],
                        'skype_label'       => ['type' => 'text'],
                        'icq_label'         => ['type' => 'text'],
                        'publish_btn'       => ['type' => 'text'],
